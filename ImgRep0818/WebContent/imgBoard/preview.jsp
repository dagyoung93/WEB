...
<script type="text/javascript">
   ...
   var makeTbl=function(obj){
      ...
      html+="<tr><th>date</th><td>"+obj.date+"</td></tr>";
   ...
   $(document).ready(function(){
      $.ajax({
         ...
         success:function(result){
            ...
            var html="<table border='1'>";
            for(i=0;i<arr.length;i++){
               html+="<tr><th class='title' num='"+arr[i].num+"'><h3 style='width:300px'>"+arr[i].title+"</h3></td></tr>";
...
<table border="1">
   <tr> <td style="height:400px"> <div id="list" ></div> </td>
      <td style="width:300px"> <div id="content"></div> </td>
    </tr>
</table>
</body>
</html>